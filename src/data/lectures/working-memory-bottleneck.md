...
prerequisites: []
key_claim: "Most failures of execution are not failures of will. They are failures of working memory — a four-slot bottleneck so small that almost every ambitious plan exceeds its capacity within an hour. The fix is not discipline. The fix is offloading."
tags: ["cognition", "attention", "memory", "execution", "deep-work"]
sources_count: 8
---
...
1. **Cal Newport — *Deep Work***
   The strongest accessible argument for protected, undisturbed cognitive intervals. Read past the autobiography and onto the structural claims.

2. **David Allen — *Getting Things Done***
   The canonical operational manual for offloading. The system is heavier than most modern readers need; the underlying philosophy is what matters.

3. **Randall Engle — review articles on working memory**
   The serious academic literature is more nuanced and more powerful than the popular treatments. Engle is a good entry point.

4. **Nelson Cowan (2001) — "The magical number 4 in short-term memory"**
   The single paper most often cited to revise Miller's seven-plus-or-minus-two downward. Worth reading even for non-academics.

5. **Wendy Wood — *Good Habits, Bad Habits***
   The most evidence-grounded popular treatment of habit formation. Pairs well with the structural account above.

6. **Matthew Walker — *Why We Sleep***
   Read with awareness of the critiques (see Alexey Guzey's public audit), but the working-memory implications of sleep are well-established and treated well in the relevant chapters.

7. **Anders Ericsson — *Peak***
   The clearest popular treatment of the role of chunking in expertise.

8. **Daniel Kahneman — *Thinking, Fast and Slow***
   The relevant chapters on System 2 effort are direct background for understanding why the buffer is so expensive to maintain.
